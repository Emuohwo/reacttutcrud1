    ...
    render() {
        ...
        <Form onSubmit={this.props.item ? this.submitFormEdit : this.submitFormAdd}>
            ...
            <FormGroup>
                ...
                <Input type="tel" name="phone" id="phone" onChange={this.onChange} valid={this.state.phone === null ? '' : this.state.phone} placeholder="ex. +23408065757457" />
            </FormGroup>
            <FormGroup>
                <Label for="location">Location </Label>
                <Input type="text" name="location" id="location" onChange={this.onChange} value={this.state.location === null ? '' : this.state.location} placeholder="State Country" /> 
            </FormGroup>
            <FormGroup>
